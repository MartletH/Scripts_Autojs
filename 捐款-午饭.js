...
// set url scheme: 免费午餐
/* var H5url = "alipays://platformapi/startapp?appId=10000009&url=/www/detail.htm?donateId=2014010616214122130"
var desctxt = "免费午餐" */
...
app.startActivity({
    action: "VIEW",
    data: "alipays://platformapi/startapp?appId=10000009&url=/www/detail.htm?donateId=2014010616214122130"
})

do {
    sleep(100) // Time for loading
}
while (!text("免费午餐").exists())
toastLog(text("免费午餐").exists() + " url opened")
